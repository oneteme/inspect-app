...
import {buildSeries,ChartConfig,pivotByStack,LDAP_STATUS_CHART_CONFIG,LDAP_PERFORMANCE_CHART_CONFIG} from "../../kpi.config";
...
export class LdapComponent implements OnInit {
  ...
  private _fetchSliceData(chartConfig: ChartConfig, filterKey: string): Observable<any[]> {
    ...
    return this._ldapRequestService.getFilters(
      filter,
  ...
  private _fetchStatus(): void {
    ...
    this._ldapRequestService.getCustom(
  ...
  getCommands() {
    ...
    this._ldapRequestService.getLdap(args)
