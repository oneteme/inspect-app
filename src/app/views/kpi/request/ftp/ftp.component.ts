...
import {buildSeries,ChartConfig,pivotByStack,FTP_STATUS_CHART_CONFIG,FTP_PERFORMANCE_CHART_CONFIG} from "../../kpi.config";
import {formatChartDates, periodManagement} from "../../../../shared/util";
...
export class FtpComponent implements OnInit {
  ...
  getCommands() {
    ...
    this._ftpRequestService.getFtp(args)
