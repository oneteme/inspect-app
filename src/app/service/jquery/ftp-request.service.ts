...
export class FtpRequestService {
    ...
    getFtpSessionExceptions(filters: { namespace: string, start: Date, end: Date, groupedBy: string, app_name: string }): Observable<FtpSessionExceptionsByPeriodAndappname[]> {
        let args = {
