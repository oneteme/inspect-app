...
export type LastServerStart = { id: string, type: string, appName: string, version: string, start: number, end: number, branch: string, hash: string, collector: string, minStart: number, lastEnv: number, restart: number, configuration: InspectCollectorConfiguration};
