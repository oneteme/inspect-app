import {InspectCollectorConfiguration} from "./trace.model";
...
export type LastServerStart = { id: string, type: string, appName: string, version: string, start: number, end: number, branch: string, hash: string, collector: string, minStart: number, lastStart: number, restart: number, configuration: InspectCollectorConfiguration};
export type ExceptionsByPeriodAndAppname = {date: string, errorType: string, count: number, countok: number, groupedBy: string, type: string};
export type MainExceptionsByPeriodAndAppname = {date: string, errorType: string, count: number, countok: number, groupedBy: string,};
export type LdapSessionExceptionsByPeriodAndappname = {countok: number,count: number, date: string, year: string, errorType: string };
export type LdapMainExceptionsByPeriodAndappname = {countok: number,count: number, date: string, year: string };
export type SmtpSessionExceptionsByPeriodAndappname = {countok: number,count: number, date: string, year: string, errorType: string  };
...
export type RestSessionExceptionsByPeriodAndappname = {countok: number,count: number, date: string, year: string, errorType: string };
export type FtpMainExceptionsByPeriodAndappname = {countok: number,count: number, date: string, year: string };
export type FtpSessionExceptionsByPeriodAndappname = {countok: number,count: number, date: string, year: string, errorType: string };
