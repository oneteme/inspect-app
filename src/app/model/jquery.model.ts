...
export type LastServerStart = { id: string, appName: string, version: string, start: number, end: number, branch: string, hash: string, collector: string, minStart: number, restart: number, configuration: InspectCollectorConfiguration};
